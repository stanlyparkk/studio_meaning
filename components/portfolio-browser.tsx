    ...
    <div className="mt-12">
      <div className="page-panel overflow-hidden">
        <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-end">
          <div>
            <p className="text-xs uppercase tracking-[0.3em] text-gold">Primary Category</p>
          ...
          <div>
            <p className="text-xs uppercase tracking-[0.3em] text-gold">Secondary Category</p>
            <div className="mt-4 flex flex-wrap gap-3">
              <button
                type="button"
        ...
        >
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-xs uppercase tracking-[0.28em] text-gold">Video Preview</p>
