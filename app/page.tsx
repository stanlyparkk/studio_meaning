    ...
    <div>
      <section className="container-shell grid gap-10 py-14 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:py-24">
        <div>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-stone/72">
        ...
        <div className="relative">
          ...
          <div className="glass-card absolute bottom-6 left-6 max-w-xs p-5 sm:bottom-8 sm:left-8">
            ...
            <p className="mt-3 text-base leading-7 text-stone/72">
                ...
                <div className="px-2 pt-5">
                  <div className="flex flex-wrap gap-2">
                    {item.categories.map((category) => (
                      <span
                        key={category}
                        className="rounded-full border border-gold/15 bg-white/60 px-3 py-1 text-[11px] uppercase tracking-[0.24em] text-gold"
                      >
                        {category}
                      </span>
                    ))}
            ...
            <div className="mt-8 grid gap-5">
              {videos.map((video) => (
                <div key={video._id} className="rounded-[1.5rem] border border-stone/10 bg-white/70 p-5">
                  ...
                  <p className="mt-3 text-sm leading-7 text-stone/72">{video.description}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="glass-card overflow-hidden p-8 sm:p-12">
          <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              ...
              <p className="mt-5 max-w-2xl text-base leading-8 text-stone/72">
